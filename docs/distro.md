...
```json
{
    "version": "1.0.0",
    "discord": {
        "clientId": "1070754255276879943",
        "smallImageText": "SocietyCraft",
        "smallImageKey": "Societycraft officiel"
    },
    "rss": " https://societycraft.tk/api/rss",
    "servers": [
        {
            "id": "SocietyCraft",
            "name": "SocietyCraft Client",
            "description": "Le serveur de SocietyCraft !",
            "icon": "https://files.societycraft.tk/logo.png",
            "version": "V1",
            "address": "societycraft.cagicac.fr",
            "minecraftVersion": "1.12.2",
            "discord": {
                "shortId": "1070754255276879943",
                "largeImageText": "SocietyCraft Officiel",
                "largeImageKey": "Rejoignez nous : https://societycraft.tk"
            },
            "mainServer": true,
            "autoconnect": true,
            "modules": [
...
```JSON
{
    ...
    "rss": "https://files.societycraft.tk/logo.png",
    "servers": []
}
```
...
```json
{
    ...
    "type": "file",
     "artifact": {
        ...
        "url": "http://files.societycraft.tk/distribution.json"
    }
}
```
